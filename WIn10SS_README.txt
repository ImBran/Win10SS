...
General Use Notes
-----------------------------------------------
This BAT is intended for powerusers to disable services, and remove bloatware packaged with Windows 10 Enterprise V.  It will create DIR in C:\Program Files\ and log all LAST RUN data with a date. 
